	            ...
	            if(waveName.equals("WaveDescription")){
	                ...
	                while(igames.hasNext()){// for each game of one wave
	                    ...
	                    while(igameinfo.hasNext()){
	                		Element element = (Element)igameinfo.next();
							if (element.getName().equals("GeneralSetting")) {
								...
								setting.maxRunningTime=Integer.valueOf(element
										.getChild("TimeOut").getValue());
							}
	                    }//for settings of a game
	                    
	                    osgame.setSettings(setting);
	                    osgame.setStatus(status);
