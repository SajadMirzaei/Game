        ...
        while(iwaves.hasNext()){//for each wave
            ...
            if(waveName.equals("WaveDescription")){
                ...
                while(igames.hasNext()){// for each game of one wave
                    ...
                    SumNumGame sngame=new SumNumGame();
                    sngame.setDescription(gameDscrpt);
                    ...
                    while(igameinfo.hasNext()){
                        ...
                        if(infoName.equals("Players")){
                            while(idetail.hasNext()){//parse out all player IDs 
                                ...
                                sngame.addPlayerToGame(Integer.parseInt(playernum));
                            }
                        }
                            ...
                            sngame.setGameParameters(goalseq,timeout,allowmatch,diffgroup);
                        }    
                        
                    }
                    gamewave.addGame(sngame);//add the game to the wave
                }   
